// ======================================================================
// Upright motor test.v generated from TopDesign.cysch
// 03/26/2014 at 14:19
...
module CharLCD_v1_90_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f2a15bcd-a99a-4038-8d5f-5d371f152802/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("125fd7a0-0f9e-4a76-95c0-a572ae62b30a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyStatusReg_v1_80 But_Reg (
        ...
        .status_7(1'b0),
        .intr(Net_271),
        .status_bus(Net_183[4:0]));
    defparam But_Reg.Bit0Mode = 0;
    defparam But_Reg.Bit1Mode = 0;
    defparam But_Reg.Bit2Mode = 0;
    defparam But_Reg.Bit3Mode = 0;
    defparam But_Reg.Bit4Mode = 0;
    defparam But_Reg.Bit5Mode = 0;
    defparam But_Reg.Bit6Mode = 0;
    defparam But_Reg.Bit7Mode = 0;
    defparam But_Reg.BusDisplay = 1;
    defparam But_Reg.Interrupt = 0;
    defparam But_Reg.MaskValue = 0;
    defparam But_Reg.NumInputs = 5;

    CyControlReg_v1_70 Cont_Reg (
        .control_1(Net_242),
        .control_2(Net_272),
        .control_3(Net_273),
        .control_0(Net_241),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Cont_Reg.Bit0Mode = 0;
    defparam Cont_Reg.Bit1Mode = 0;
    defparam Cont_Reg.Bit2Mode = 0;
    defparam Cont_Reg.Bit3Mode = 0;
    defparam Cont_Reg.Bit4Mode = 0;
    defparam Cont_Reg.Bit5Mode = 0;
    defparam Cont_Reg.Bit6Mode = 0;
    defparam Cont_Reg.Bit7Mode = 0;
    defparam Cont_Reg.BitValue = 0;
    defparam Cont_Reg.BusDisplay = 0;
    defparam Cont_Reg.ExtrReset = 0;
    defparam Cont_Reg.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("e7c9aac8-0786-4f42-961e-a30ec961f8ac"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aa25ac25-b062-49a7-b2e4-e7bc685a3b17"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    defparam Debounce.SignalWidth = 5;

	wire [0:0] tmpOE__Menu_net;
	wire [0:0] tmpIO_0__Menu_net;
	wire [0:0] tmpINTERRUPT_0__Menu_net;
	electrical [0:0] tmpSIOVREF__Menu_net;

	cy_psoc3_pins_v1_10
		#(.id("73673a32-57b8-456c-b3df-74d6a757be70"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Menu
		 (.oe(tmpOE__Menu_net),
		  .y({1'b0}),
		  .fb({Net_218[2]}),
		  .io({tmpIO_0__Menu_net[0:0]}),
		  .siovref(tmpSIOVREF__Menu_net),
		  .interrupt({tmpINTERRUPT_0__Menu_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Menu_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("be05c678-4f97-409d-80ce-5d47f4d46cf0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_Up_net;
	wire [0:0] tmpFB_0__LED_Up_net;
	wire [0:0] tmpIO_0__LED_Up_net;
	wire [0:0] tmpINTERRUPT_0__LED_Up_net;
	electrical [0:0] tmpSIOVREF__LED_Up_net;

	cy_psoc3_pins_v1_10
		#(.id("79547f73-b355-47b5-b77c-80bdad70e232"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		LED_Up
		 (.oe(tmpOE__LED_Up_net),
		  .y({Net_241}),
		  .fb({tmpFB_0__LED_Up_net[0:0]}),
		  .io({tmpIO_0__LED_Up_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Up_net),
		  .interrupt({tmpINTERRUPT_0__LED_Up_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Up_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_Down_net;
	wire [0:0] tmpFB_0__LED_Down_net;
	wire [0:0] tmpIO_0__LED_Down_net;
	wire [0:0] tmpINTERRUPT_0__LED_Down_net;
	electrical [0:0] tmpSIOVREF__LED_Down_net;

	cy_psoc3_pins_v1_10
		#(.id("4682230c-bde9-4d34-9100-e12eb18e0901"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		LED_Down
		 (.oe(tmpOE__LED_Down_net),
		  .y({Net_242}),
		  .fb({tmpFB_0__LED_Down_net[0:0]}),
		  .io({tmpIO_0__LED_Down_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Down_net),
		  .interrupt({tmpINTERRUPT_0__LED_Down_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Down_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__stop_net;
	wire [0:0] tmpIO_0__stop_net;
	wire [0:0] tmpINTERRUPT_0__stop_net;
	electrical [0:0] tmpSIOVREF__stop_net;

	cy_psoc3_pins_v1_10
		#(.id("884e4203-88f3-4186-8917-cea0f96f1b0d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		stop
		 (.oe(tmpOE__stop_net),
		  .y({1'b0}),
		  .fb({Net_280}),
		  .io({tmpIO_0__stop_net[0:0]}),
		  .siovref(tmpSIOVREF__stop_net),
		  .interrupt({tmpINTERRUPT_0__stop_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stop_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
